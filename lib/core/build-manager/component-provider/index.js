...
class ComponentProvider {
  ...
  getComponent(componentData, requirements) {
    ...
    const recipeDir = this.logicProvider.findRecipeFolder(componentData.id, this.recipeDirectories);
    const RecipeClass = this.logicProvider.getRecipeClass(componentData.id, recipeDir, requirements);
