...
class ComponentProvider {
  ...
  getRecipe(id, requirements) {
    const recipeDir = this.logicProvider.findRecipeFolder(id, this.recipeDirectories);
    return {
      metadata: this.metadataProvider.getMetadata(id, {recipeDir, requirements}),
      componentClass: this.logicProvider.getRecipeClass(id, recipeDir, requirements)
    };
  }
